    ...
    <span className="sr-only">Loading...</span>
     ...
     <div>
      <Link to="/" className="inline-block">
            <button className=' font-bold  mt-2 btn bg-fuchsia-800 text-white rounded-md px-5 hover:scale-105 hover:bg-fuchsia-900 transition shadow-2xl' >Go back</button>
